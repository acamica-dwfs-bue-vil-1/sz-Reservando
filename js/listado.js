...
Listado.prototype.buscarRestaurante = function(id) {
    var resultado = this.restaurantes.find( function(rest){
        if(rest.id === id){
            return rest;
        } 
    });
    if(resultado === undefined){
        resultado = 'No se ha encontrado ningún restaurant';
    }
    return resultado;
}

function filtrar(arr){
    var arrFiltrado = arr.filter(function(elem, index, self) {
...
Listado.prototype.obtenerPorCiudad = function() {
    ...
    //Se crea un nthisuevo array donde se van a agregar las ciudades pero sin repetirse
...
Listado.prototype.obtenerPorRubro = function() {
...
var listadoDeRestaurantes = [
    ...
    new Restaurant(26, "Maison kk", "Almuerzo", "Munro City", ["21:00", "22:30", "15:00"], "../img/desayuno2.jpg", [1, 2, 3, 4, 5]),
];
